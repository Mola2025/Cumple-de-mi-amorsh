...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DVvlntg0.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-OtIe6W5J.js"),
    import("./start-LLodfigu.js"),
...
var ROUTER_BASEPATH = "Cumple-de-mi-amorsh";
var SERVER_FN_BASE = "/Cumple-de-mi-amorsh/_serverFn/";
