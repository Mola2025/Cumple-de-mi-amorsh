...
const appCss = "/Cumple-de-mi-amorsh/assets/styles-CDi5te1t.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Una pequeña página dedicada a ti en tu día especial." },
      { name: "author", content: "Para ti" },
      { property: "og:title", content: "Feliz Cumpleaños, mi amor" },
      { property: "og:description", content: "Una pequeña página dedicada a ti en tu día especial." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,600;1,400&family=Great+Vibes&family=Inter:wght@300;400;500&display=swap"
      }
    ]
  }),
...
const $$splitComponentImporter = () => import("./index-DbbivVbv.js");
